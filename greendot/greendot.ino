...
void loop() {
  ...
  //here i possibly define "black" as a 32-bit type
  uint32_t black = strip.Color(0, 0, 0);

  // here I assign all the LEDs to be black
  strip.fill(black, 0, 10);
  

  //here i assign "green" as a 32-bit type
  uint32_t green = strip.Color(0, 255, 0);
  
  // here I assign the LED at location "counter" to be green
  strip.setPixelColor(counter, green);

  strip.setPixelColor((counter+5)%10, green);
